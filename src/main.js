...
import ScoreOverviewScene from "./OverviewScene.js";
...
const config = {
  ...
  scene: [StartScene, Arena1_New, Arena1_New_Multi, PauseScene, LoadingScene, LobbyScene, GameOverScene, ScoreOverviewScene],
  pixelArt: true,
  scale: {
